 ...
 */
#ifdef BLUETOOTH_RTK //for realtek bluetooth
	#ifndef _BDROID_BUILDCFG_H
	#define _BDROID_BUILDCFG_H

	#define BTM_DEF_LOCAL_NAME   "BPI-M2M"
	...
	#endif
#else // for ap6xxx broadcome bluetooth
	#ifndef _BDROID_BUILDCFG_H
	#define _BDROID_BUILDCFG_H

#define BTM_DEF_LOCAL_NAME   "SINOVOIP-bpi-m2m-lcd7"
